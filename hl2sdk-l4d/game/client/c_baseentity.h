...
//typedef CHandleV<C_BaseEntity> EHANDLE; // The client's version of EHANDLE.
//
...
struct PredictionContext
{
	...
	CHandleV< C_BaseEntity >		m_hServerEntity;
};
#endif
...
//	QAngle							m_vecAbsAngVelocity;
	...
	unsigned char					m_iParentAttachment; if we're relative to the parent's absorigin and absangles.
	...
	// Hierarchy
	CHandleV<C_BaseEntity>			m_pMoveParent;
	CHandleV<C_BaseEntity>			m_pMoveChild;
	CHandleV<C_BaseEntity>			m_pMovePeer;
	CHandleV<C_BaseEntity>			m_pMovePrevPeer;

	// The moveparent received from networking data
	CHandleV<C_BaseEntity>			m_hNetworkMoveParent;
	CHandleV<C_BaseEntity>			m_hOldMoveParent;
	...
	CHandleV< CBasePlayer >			m_hPlayerSimulationOwner;
#endif
...
//{
//	return (RenderMode_t)(unsigned char)m_nRenderMode; // KRONEX_FIX
//}
...
//inline unsigned char CBaseEntity::GetParentAttachment() const // KRONEX_FIX
//{
...
//inline ClientRenderHandle_t CBaseEntity::GetRenderHandle() const  // KRONEX_FIX
//{ 
//	return m_hRender; 
//}
//
//inline ClientRenderHandle_t& CBaseEntity::RenderHandle() // KRONEX_FIX
//{
//	return m_hRender;
//}
