...
protected:
	...
	typedef CHandleV<CBaseViewModel> CBaseViewModelHandle;
...
#if !defined( NO_ENTITY_PREDICTION )
	CUtlVector< CHandleV< CBaseEntity > > m_SimulatedByThisPlayer;
#endif
...
typedef CHandleV<CBasePlayer> CBasePlayerHandle;
