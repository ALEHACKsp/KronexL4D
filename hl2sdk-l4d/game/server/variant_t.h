...
#ifndef valve_variant_t_H
#define valve_variant_t_H
#ifdef _WIN32
#pragma once
#endif
...
class valve_variant_t
{
	...
	CHandleV<CBaseEntity> eVal; // this can't be in the union because it has a constructor.
...
public:
	...
	// constructor
	valve_variant_t() : iVal(0), fieldType(FIELD_VOID) {}
	...
	inline const CHandleV<CBaseEntity> &Entity(void) const;
...
//-----------------------------------------------------------------------------
inline void valve_variant_t::Vector3D(Vector &vec) const
{
...
//-----------------------------------------------------------------------------
inline const CHandleV<CBaseEntity> &valve_variant_t::Entity(void) const
{
	if ( fieldType == FIELD_EHANDLE )
		return eVal;

	static CHandleV<CBaseEntity> hNull;
	hNull.Set(NULL);
	return(hNull);
}


#endif // valve_variant_t_H
